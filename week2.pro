...
;restore & plot for 0 degree phase shifted signals, +delta v (positive)
  ...
  ps_ch, 'week_2_5_3_add_0deg.ps', xsize=10, ysize=10, /color
  plot, time*1e6, sig[100:N+99], color = !black, title = "USB Graph for 0 Degree Phase Shift. Real: Black. Imaginary: Blue.", xtitle = 'Time (seconds)', ytitle = 'Real and Imaginary Values', charsize = 1.5
  oplot, time*1e6, shift[100:N+99], color = !blue, psym = -4
...
;restore & plot for 0 degree phase shifted signals, -delta v (negative)
  ...
  plot, time*1e6, sig[100:N+99], color = !black, title = "LSB Graph for 0 Degree Phase Shift. Real: Black. Imaginary: Blue.", xtitle = 'Time (microseconds)', ytitle = 'Real and Imaginary Values', charsize = 1.5
  oplot, time*1e6, shift[100:N+99], color = !blue, psym = -4
  plot, xoutput/1e6, power, psym = -4, charsize = 1.5, title = textoidl('Power Spectrum for \deltaw < 0'), xtitle = 'Frequency (megahertz)', ytitle = 'Power'
  ps_ch, /close
end
...
;restore & plot for 90 degree phase shifted signals, +delta v (positive)
 ...
 plot, time*1e6, sig[100:N+99], color = !black, title = "USB Graph for 90 Degree Phase Shift. Real: Black. Imaginary: Blue.", xtitle = 'Time (microseconds)', ytitle = 'Real and Imaginary Values', charsize = 1.5
 oplot, time*1e6, shift[100:N+99], color = !blue, psym = -4
 plot, xoutput/1e6, power, psym = -4, charsize = 1.5, title = textoidl('Power Spectrum for \deltaw > 0'), xtitle = 'Frequency (megahertz)', ytitle = 'Power'
 ps_ch, /close
end
...
;restore & plot for 90 degree phase shifted signals, -delta v (negative)
 ...
 plot, time*1e6, sig[100:N+99], color = !black, title = "LSB Graph for 90 Degree Phase Shift. Real: Black. Imaginary: Blue.", xtitle = 'Time (microseconds)', ytitle = 'Real and Imaginary Values', charsize = 1.5
 oplot, time*1e6, shift[100:N+99], color = !blue, psym = -4
 plot, xoutput/1e6, power, psym = -4, charsize = 1.5, title = textoidl('Power Spectrum for \deltaw < 0'), xtitle = 'Frequency (megahertz)', ytitle = 'Power'
 ps_ch, /close
end
